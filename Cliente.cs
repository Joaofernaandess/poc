namespace Teste // mostrando dentro da onde o comando deve agir 
{
    public class Cliente// significa que a classe Cliente todo o projeto tem acesso 
    {
        ...
        public Guid Id { get; set; }// public todo tem acesso - Guid que dizer q essa propriedade so aceita esse tipo de dado 
